  ...
  return (
    <section className="bg-background flex w-full flex-col items-center py-20 px-5 md:px-20">
      <div className="flex w-full max-w-7xl flex-col items-center">
        ...
        <article className="bg-accent w-full overflow-hidden mt-16 p-10 rounded-3xl max-md:mt-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col">
              ...
              <h3 className="text-accent-foreground text-4xl font-bold tracking-tight mt-7">
                Intuitive dashboard
              </h3>
              <p className="text-accent-foreground text-[15px] font-medium leading-relaxed mt-8">
                THEUNOiA's dashboard is designed to give you everything you need at a glance.
              </p>
              <div className="flex gap-8 text-accent-foreground font-bold mt-14 flex-wrap">
              ...
              <div className="bg-background w-full mt-14 px-6 py-6 rounded-3xl">
